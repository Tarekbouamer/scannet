...
def process_scan(opt, scan_job, count=None, progress=None):
  ...
  if opt.export_depth_images:
    sd.export_depth_images(os.path.join(output_path, 'sensor_data'), image_size=opt.depth_resize, frame_skip=opt.frame_skip)
  if opt.export_color_images:
    sd.export_color_images(os.path.join(output_path, 'sensor_data'), image_size=opt.rgb_resize, frame_skip=opt.frame_skip)
  if opt.export_poses:
    sd.export_poses(os.path.join(output_path, 'sensor_data'), frame_skip=opt.frame_skip)
